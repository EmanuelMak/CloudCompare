...
import de.th.ro.thesis.emanuel.checkprime.ApiGatewayResponse;
import com.google.gson.Gson;
import com.th.ro.emanuel.thesis.checkprime.PrimeChecker;

public class PrimeCheckLambdaHandler implements RequestHandler<Map<String, Object>, ApiGatewayResponse> {

    private static final String DB_HOST = System.getenv("DB_HOST");
    private static final String DB_USER = System.getenv("DB_USER");
    private static final String DB_PASSWORD = System.getenv("DB_PASSWORD");
    private static final String DB_NAME = System.getenv("DB_NAME");
    private static final String DB_URL = "jdbc:postgresql://" + System.getenv("DB_HOST") + ":5432/"
            + System.getenv("DB_NAME") + "?ssl=true&sslfactory=org.postgresql.ssl.NonValidatingFactory";
    ...
    public ApiGatewayResponse handleRequest(Map<String, Object> event, Context context) {
        ...
        PrimeCheckResponse response = null;
        if (queryStringParameters == null || !queryStringParameters.containsKey("number")) {
            response =  new PrimeCheckResponse("Parameter 'number' is required.");
        } else {
            ...
            try {
                ...
                throw new RuntimeException("Invalid format for number. Must be a number.");
            }
            ...
            try (Connection connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD)) {
                ...
                response =  new PrimeCheckResponse(isPrime, allPrimes);
